...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        #self.message_box_start.setIcon(self, QMessageBox.warning)
    ...
    def count_time(self):
        ...
        if self.secondi==10:
            ...
            self.secondi=0
        self.tentativo=self.tentativo +0.1
    ...
    def initUIStatistiche(self):
        ...
        self.icona_batteria.setMargin(35)
        #self.layoutH_batteria_statistiche.setContentsMargins(1750, 10, 50,0)
