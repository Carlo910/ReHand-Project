...
{
    uint8 staticBits = (R_Pin_DR & (uint8)(~R_Pin_MASK));
    R_Pin_DR = staticBits | ((uint8)(value << R_Pin_SHIFT) & R_Pin_MASK);
}
...
{
	CyPins_SetPinDriveMode(R_Pin_0, mode);
}
...
{
    return (R_Pin_PS & R_Pin_MASK) >> R_Pin_SHIFT;
}
...
{
    return (R_Pin_DR & R_Pin_MASK) >> R_Pin_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(R_Pin_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & R_Pin_0_INTR) != 0u) 
		{ 
			 R_Pin_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (R_Pin_INTSTAT & R_Pin_MASK) >> R_Pin_SHIFT;
    }
